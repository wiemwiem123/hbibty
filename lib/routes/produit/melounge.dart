...
class melounge extends StatefulWidget {
  @override
  State<melounge> createState() => _meloungeState();
}

class _meloungeState extends State<melounge> {
  int _counter = 0;
                ...
                child: Stack(
                  children: <Widget>[
                    IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushNamed(context, 'melounge1');
                        }),
                    SizedBox(
                      width: 10,
                    ),
